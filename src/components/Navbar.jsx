    ...
    >
      ...
      <div
        className="flex items-center justify-center bg-gray-200 rounded
                   w-[120px] h-[32px] sm:w-[150px] sm:h-[38px] xl:w-[182px] xl:h-[44px]"
      >
      ...
      {/* Mobile Menu */}
      <div
        className={`xl:hidden absolute top-full left-0 w-full bg-white shadow-lg transform transition-all duration-300 ease-in-out overflow-hidden ${
